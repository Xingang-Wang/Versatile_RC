...
lb = [0 0 0 10^-10 0];
ub = [3 3 1 10^-2  1];
[train_data,train_output_data,testdata,test_output_data,train_length,train_num]=func_dataset_Kur_para();
...
min_rmse = @(x) (func_train_repeat_Kur_para(x,repeat_num,train_data,train_output_data,testdata,test_output_data,train_length,train_num));
